...
6.  When a problem is stated as a question in English, the prefered style is to 
    ...
    If the problem is not stated as a question, the following style is prefered:
    ```lean
